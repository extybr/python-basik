...
volume_planet = 4 / 3 * 3.14159 * radius ** 3
volume_earth = 10.8321 * 10 ** 11
if volume_earth < volume_planet:
    multiplicity = round(volume_planet / volume_earth, 3)
    print('Объём планеты Земля меньше в', multiplicity, 'раз')
else:
    multiplicity = round(volume_earth / volume_planet, 3)
    print('Объём планеты Земля больше в', multiplicity, 'раз')