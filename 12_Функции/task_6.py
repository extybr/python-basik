...
def find_point():
    number_x = float(input('Введите координаты икс: '))
    number_y = float(input('Введите координаты игрек: '))
    while abs(number_x) > 1 or 1 < abs(number_y):
        print('Монетки в области нет\n')
        number_x = float(input('Введите координаты икс: '))
        number_y = float(input('Введите координаты игрек: '))
        if abs(number_x) < 1 > abs(number_y):
